...
class.addSpell('nuke', {'Glacial Spear', 'Trushar\'s Frost'}, {opt='USENUKES'})
...
class.addSpell('groupregen', {'Feral Vigor', 'Spiritual Vigor'}) -- group buff
...
table.insert(class.burnAbilities, common.getAA('Frenzy of Spirit')) -- burn disc
...
if class.spells.fero == 'Ferocity' then
...
class.recover_class = function()
    if mq.TLO.Group.LowMana(50)() >= 3 and paragon:isReady() then
        paragon:use()
    end
