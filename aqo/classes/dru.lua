...
Druid.SpellLines = {
    ...
    {Group='dot1', Spells={'Nature\'s Boiling Wrath', 'Nature\'s Sweltering Wrath', 'Nature\'s Fervid Wrath', 'Nature\'s Blistering Wrath', 'Nature\'s Fiery Wrath', --[[emu cutoff]] 'Flame Lick'}, Options={opt='USEDOTS'}},
    {Group='dot2', Spells={'Horde of Hotaria', 'Horde of Duskwigs', 'Horde of Hyperboreads', 'Horde of Polybiads', 'Horde of Aculeids', 'Wasp Swarm', 'Swarming Death', 'Winged Death', 'Stinging Swarm'}, Options={opt='USEDOTS'}},
    ...
    {Group='nuke1', Spells={'Remote Sunscorch', 'Remote Sunbolt', 'Remote Sunshock', 'Remote Sunblaze', 'Remote Sunflash', --[[emu cutoff]] 'Ignite', 'Burst of Fire', 'Burst of Flame'}, Options={opt='USENUKES'}}, -- nuke + heal tot
    ...
    {Group='singleskin', Spells={'Emberquartz Skin', 'Luclinite Skin', 'Opaline Skin', 'Arcronite Skin', 'Shieldstone Skin', --[[emu cutoff]] 'Skin like Wood'}},
    ...
    {Group='ds', Spells={'Shield of Thistles'}, Options={singlebuff=true}},
    {Group='sow', Spells={'Spirit of Wolf'}, Options={singlebuff=true}},
    -- Aura
    ...
    {Group='summonednuke', Spells={'Ward Summoned'}, Options={opt='USENUKES', condition=function() return false end}}, -- summoned mobs only
    {Group='outdoornuke', Spells={'Whirling Wind'}, Options={opt='USENUKES', condition=function() return false end}}, -- outdoor only
    {Group='rainnuke', Spells={'Invoke Lightning'}, Options={opt='USEAOE'}},
}
